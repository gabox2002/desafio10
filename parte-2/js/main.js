...
// Agregar el HTML del libro 1 al articulo correspondiente
document.getElementById('libros').innerHTML += libro01.getHtmlArticle();

// Obtener el contenedor de libros dinamicamente
let elemLibrosContainer = document.getElementById('libros');

// Crear instancias de 4 objetos Libro
...
// Almacenar el h1 existente
let h1Existente = elemLibrosContainer.querySelector('h1');

// Generar HTML de los nuevos libros
let htmlNuevosLibros = libro1.getHtmlArticle()
                     + libro2.getHtmlArticle()
                     + libro3.getHtmlArticle()
                     + libro4.getHtmlArticle();

// Limpiar el contenido existente en el contenedor de libros
elemLibrosContainer.innerHTML = '';

// Agregar el h1 de nuevo
elemLibrosContainer.appendChild(h1Existente);

// Agregar el HTML al contenedor de libros
